...
namespace JQSelenium
{
    ...
    public class JQuerySelector : IEnumerable<JQueryTag>
    {
        ...
        public JQuerySelector(JQueryTag jQueryTag)
        {
            ...
            var result = jQueryTag.getSelector().Split(']');
            if(result[result.Count()-1].Equals(""))
            {
                selector = "jQuery(" + jQueryTag.Selector + ")";
            }else
            {
                selector = jQueryTag.Selector;
            }
            iterator = 0;
            js = jQueryTag.getJS();
            Count = 1;
        ...
        public JQuerySelector(IJavaScriptExecutor js, string selector, List<IWebElement> subset)
        {
            ...
            for (var i = 0; i < subset.Count; i++)
            {
                try
                {
                    var jqt = new JQueryTag(js, selector, i, subset[i]);
                    _subset.Add(jqt);
                }
        ...
        public JQuerySelector add(string selector_elements_html)
        {
            ...
            if (requiresApostrophe(selector_elements_html))
            {
                ...
                newSelector = selector + ".add('" + selector_elements_html + "')";
            }
            else
            {
                result = execJS("", ".add(" + selector_elements_html + ")");
        ...
        public JQuerySelector add(string selector, string context)
        {
            ...
            var newSelector = this.selector + ".add('" + selector + "'," + context + ")";
            _subset = objectToJQueryTagList(result);
            overwriteSelectors(newSelector);
            Count = _subset.Count;
            return this;
        ...
        public JQuerySelector before(params string[] content_content)
        {
            ...
            result = execJS("", ".before(" + resultingContent + ")");
            _subset = objectToJQueryTagList(result);
            return this;
        }
        ...
        {
            return js.ExecuteScript("return " + preffix + selector + suffix);
        }
        ...
        public JQuerySelector find(string selector)
        {
            ...
            return new JQuerySelector(js, this.selector + ".find('" + selector + "')", objectToWebElementList(result));
        }
        ...
        public JQueryTag first()
        {
            ...
            return new JQueryTag(js, selector, 0, objectToWebElementList(result)[0]);
        }
        ...
        public bool hasClass(string className)
        {
            ...
            {
                if (element.WebElement.GetAttribute("class").Contains(className))
                    return true;
            }
            return false;
        }
        ...
        public JQueryTag last()
        {
            ...
            return new JQueryTag(js, selector, _subset.Count - 1, webElements[0]);
        }
        ...
        List<JQueryTag> objectToJQueryTagList(Object result)
        {
            ...
            if (result is Dictionary<string, Object>)
            {
                ...
                var length = Convert.ToInt32(dictionary["length"]);
                for (var i = 0; i < length; i++)
                {
                    jQueryTags.Add(new JQueryTag(js, selector, i, (IWebElement) dictionary[Convert.ToString(i)]));
                }
            }
            else
            {
                var webElements = new List<IWebElement>(((ReadOnlyCollection<IWebElement>) result));
                for (var i = 0; i < webElements.Count; i++)
                {
        ...
        List<IWebElement> objectToWebElementList(Object result)
        {
        ...
        public JQuerySelector parent()
        {
            ...
            List<IWebElement> webElements = objectToWebElementList(result);
            return new JQuerySelector(js, selector + ".parent()", webElements);
        }
        ...
        {
            var result = execJS("", ".next()");
            var webElements = objectToWebElementList(result);
            return new JQuerySelector(js, selector+".next()",webElements);
        }
        ...
        {
            var result = execJS("", ".next(" + selector + ")");
            var webElements = objectToWebElementList(result);
            return new JQuerySelector(js, selector + ".next()", webElements);
        }
        ...
        {
            var preResult = execJS("", ".nextAll()");
            var webElements = objectToWebElementList(preResult);
            return new JQuerySelector(js, selector + ".nextAll()", webElements);
        }
        ...
        {
            var result = execJS("", ".prev()");
            var webElements = objectToWebElementList(result);
            return new JQuerySelector(js, selector + ".prev()", webElements);
        }
        ...
        {
            var result = execJS("", ".prev(" + selector + ")");
            var webElements = objectToWebElementList(result);
            return new JQuerySelector(js, selector + ".prev()", webElements);
        }
        ...
        {
            var preResult = execJS("", ".prevAll()");
            var webElements = objectToWebElementList(preResult);
            return new JQuerySelector(js, selector + ".prevAll()", webElements);
        }
        ...
        {
            var result = "";
            foreach (var element in _subset)
            {
        ...
        {
            var result = execJS("", ".andSelf()");
            var webElements = objectToWebElementList(result);
            return new JQuerySelector(js, selector + ".andSelf()", webElements);
        }
        ...
        {
            var preResult = execJS("", ".children()");
            var webElements = objectToWebElementList(preResult);
            return new JQuerySelector(js, selector + ".children()", webElements);
        }
        ...
        {
            var preResult = execJS("", ".children(" + selector + ")");
            var webElements = objectToWebElementList(preResult);
            return new JQuerySelector(js, selector + ".children()", webElements);
        }
